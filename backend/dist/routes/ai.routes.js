...
router.get('/predict-stream', auth_1.auth, aiController.predictOptimalStream);
// Test analysis endpoint - provides detailed analysis of test results
router.get('/analyze-test', auth_1.auth, aiController.analyzeTestResults);
...
router.get('/explain-weights', auth_1.auth, aiController.explainWeights);
