...
exports.getEmployabilityInsights = exports.getCourseRecommendations = exports.getFutureProofSkills = exports.getCareerInsights = void 0;
...
const getCareerInsights = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting career insights:', error);
        res.status(500).json({
            success: false,
...
exports.getCareerInsights = getCareerInsights;
/**
 * Get future-proof skills recommendations
 */
const getFutureProofSkills = async (req, res) => {
    try {
        const { stream } = req.params;
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        ...
        logger_1.logger.error('Error getting future-proof skills:', error);
        res.status(500).json({
            success: false,
...
exports.getFutureProofSkills = getFutureProofSkills;
/**
...
const getCourseRecommendations = async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error getting course recommendations:', error);
        res.status(500).json({
            success: false,
 ...
 */
const getEmployabilityInsights = async (req, res) => {
    try {
        const { stream } = req.params;
        const userId = req.userId;
        const user = await User_1.default.findById(userId);
        ...
        logger_1.logger.error('Error getting employability insights:', error);
        res.status(500).json({
            success: false,
...
exports.getEmployabilityInsights = getEmployabilityInsights;
// Helper functions
const generateCareerInsights = async (stream, user) => {
...
const generateFutureProofSkills = async (stream, user) => {
...
const generateCourseRecommendations = async (stream, user) => {
...
const generateEmployabilityInsights = async (stream, user) => {
...
const getStreamCareerData = (stream) => {
    const streamData = {
        MPC: {
...
const getFutureProofSkillsData = (stream) => {
    const skillsData = {
        MPC: {
            essential: [
...
const getCourseRecommendationsData = (stream) => {
    return {
        free: [
            {
...
const getEmployabilityData = (stream) => {
    return {
        tier1: {
